...
Functional port of the sycl-tla example examples/cute/tutorial/xe5/amma_dual_mma_xe5.cpp, runnable on the CPU.
**Dual-group** MMA: a lane pair (ThrID=2) splits M/N in half.

Run:  python examples/xe5/amma_dual_mma_xe5.py
Each section below is one operation; the same content is in amma_dual_mma_xe5.ipynb as cells."""
...
# ----------------------------------------------------------------------
# Step — dual-group MMA (lane-pair M split)
# ----------------------------------------------------------------------
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → dual-group MMA → store.')
