...
"""XE5 dual-group AMMA GEMM (workgroup)

Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe5/amma_dual_mma_wg_xe5.cpp.
Dual-group MMA at workgroup scope.

Run:  python examples/xe5/amma_dual_mma_wg_xe5.py"""
