...
Functional port of the sycl-tla example examples/cute/tutorial/xe5/amma_dual_mma_wg_xe5.cpp, runnable on the CPU.
Dual-group MMA at **workgroup** scope (maskless barriers).

Run:  python examples/xe5/amma_dual_mma_wg_xe5.py
Each section below is one operation; the same content is in amma_dual_mma_wg_xe5.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → dual-group (workgroup) MMA → store.')
