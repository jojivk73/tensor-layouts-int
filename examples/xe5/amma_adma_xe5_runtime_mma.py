...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe5/amma_adma_xe5_runtime_mma.cpp.
Shapeless async_gmma: shape from a runtime control word.
...
# Runtime-shaped MMA
# ----------------------------------------------------------------------
# Runtime/shapeless MMA: the MMA shape is read from a control word at run time.
mma_ctrl = {"M": BLK_M, "N": BLK_N, "K": BLK_K}
print("runtime MMAControl:", mma_ctrl)
check("control matches tile", (mma_ctrl["M"], mma_ctrl["N"], mma_ctrl["K"]) == (BLK_M, BLK_N, BLK_K))
