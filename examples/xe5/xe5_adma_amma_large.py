...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe5/xe5_adma_amma_large.cpp.
LARGE SLM core matrices.
...
atom = make_xe5_amma_atom("XE5_AMMA_LARGE", "amma (large cm)", "f32", DT, DT, "f32", BLK_M, BLK_N, BLK_K)
slmA = make_slm_layout_elem(DBITS, BLK_M, BLK_K); slmB = make_slm_layout_elem(DBITS, BLK_N, BLK_K)
print("LARGE core-matrix atom:", atom.name)
print("SLM A tile:", slmA, " size:", size(slmA), " bijective:", is_bijective(slmA))
