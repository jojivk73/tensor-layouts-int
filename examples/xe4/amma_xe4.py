...
Functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_xe4.cpp, runnable on the CPU.
The simplest AMMA GEMM: load A/B into SLM, run the systolic MMA, store C.

Run:  python examples/xe4/amma_xe4.py
Each section below is one operation; the same content is in amma_xe4.ipynb as cells."""
