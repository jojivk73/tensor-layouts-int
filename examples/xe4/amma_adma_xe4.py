...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4.cpp.
AMMA fed by the ADMA async copy engine, staged K-loop.
