...
Functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4.cpp, runnable on the CPU.
AMMA fed by the ADMA async copy engine.

Run:  python examples/xe4/amma_adma_xe4.py
Each section below is one operation; the same content is in amma_adma_xe4.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: ADMA load → AMMA → store.')
