...
"""XE4 GEMM LDSM warp-row epilogue

Functional port of the sycl-tla example examples/cute/tutorial/xe4/gemm_ldsm_warp_row_epilogue_xe4.cpp, runnable on the CPU.
Epilogue via **LDSM warp-row**: a result row is co-resident in one subgroup.

Run:  python examples/xe4/gemm_ldsm_warp_row_epilogue_xe4.py
Each section below is one operation; the same content is in gemm_ldsm_warp_row_epilogue_xe4.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → MMA → LDSM warp-row epilogue → store.')
