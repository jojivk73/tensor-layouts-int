...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/gemm_async_reduce_xe4.cpp.
Split-K partials combined by an async store-reduce.
