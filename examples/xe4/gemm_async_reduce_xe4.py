...
"""XE4 GEMM async store-reduce

Functional port of the sycl-tla example examples/cute/tutorial/xe4/gemm_async_reduce_xe4.cpp, runnable on the CPU.
Split-K partials combined by an async ADMA store-reduce.

Run:  python examples/xe4/gemm_async_reduce_xe4.py
Each section below is one operation; the same content is in gemm_async_reduce_xe4.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → split-K → store-reduce.')
