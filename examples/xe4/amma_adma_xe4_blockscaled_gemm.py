...
Functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4_blockscaled_gemm.cpp, runnable on the CPU.
fp8 mantissas with per-K-block scale factors.

Run:  python examples/xe4/amma_adma_xe4_blockscaled_gemm.py
Each section below is one operation; the same content is in amma_adma_xe4_blockscaled_gemm.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → scaled MMA → store.')
