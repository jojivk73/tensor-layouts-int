...
"""XE4 block-scaled (MX) GEMM

Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4_blockscaled_gemm.cpp.
fp8 mantissas with per-K-block scale factors.

Run:  python examples/xe4/amma_adma_xe4_blockscaled_gemm.py"""
