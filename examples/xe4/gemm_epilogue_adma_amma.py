...
Functional port of the sycl-tla example examples/cute/tutorial/xe4/gemm_epilogue_adma_amma.cpp, runnable on the CPU.
Fused epilogue (SiLU + C-multiply), D-barrier tracked.

Run:  python examples/xe4/gemm_epilogue_adma_amma.py
Each section below is one operation; the same content is in gemm_epilogue_adma_amma.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: load → MMA → fused epilogue → store.')
