...
"""XE4 AMMA + ADMA GEMM (cluster)

Functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4_cluster.cpp, runnable on the CPU.
AMMA with a **cluster multicast** load: B is broadcast to every CTA.

Run:  python examples/xe4/amma_adma_xe4_cluster.py
Each section below is one operation; the same content is in amma_adma_xe4_cluster.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: multicast B → AMMA → store.')
