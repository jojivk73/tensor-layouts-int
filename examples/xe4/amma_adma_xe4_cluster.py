...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4_cluster.cpp.
Cluster multicast of B into the AMMA GEMM.
