...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/amma_adma_xe4_blockscaled_gemm_cluster.cpp.
Block-scaled GEMM with cluster multicast.
