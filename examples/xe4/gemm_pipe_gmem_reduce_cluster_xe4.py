...
Functional port of the sycl-tla example examples/cute/tutorial/xe4/gemm_pipe_gmem_reduce_cluster_xe4.cpp, runnable on the CPU.
Cluster CTAs produce partials reduced in global memory.

Run:  python examples/xe4/gemm_pipe_gmem_reduce_cluster_xe4.py
Each section below is one operation; the same content is in gemm_pipe_gmem_reduce_cluster_xe4.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: multicast → partials → gmem reduce.')
