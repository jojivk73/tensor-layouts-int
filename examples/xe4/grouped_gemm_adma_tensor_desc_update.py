...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/grouped_gemm_adma_tensor_desc_update.cpp.
Independent GEMMs in one launch; full flow per group.

Run:  python examples/xe4/grouped_gemm_adma_tensor_desc_update.py"""
