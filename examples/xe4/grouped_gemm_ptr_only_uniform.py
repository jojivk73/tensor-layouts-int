...
"""XE4 grouped GEMM (ptr-array uniform)

Functional port of the sycl-tla example examples/cute/tutorial/xe4/grouped_gemm_ptr_only_uniform.cpp, runnable on the CPU.
Grouped GEMM with a uniform pointer-array schedule.

Run:  python examples/xe4/grouped_gemm_ptr_only_uniform.py
Each section below is one operation; the same content is in grouped_gemm_ptr_only_uniform.ipynb as cells."""
...
# Recap
# ----------------------------------------------------------------------
print('Recap: loop over groups (uniform schedule).')
