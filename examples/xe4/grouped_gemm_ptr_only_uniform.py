...
Full-execution-flow functional port of the sycl-tla example examples/cute/tutorial/xe4/grouped_gemm_ptr_only_uniform.cpp.
Grouped GEMM, uniform pointer-array schedule.
